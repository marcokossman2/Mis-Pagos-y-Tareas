    ...
    <div className="flex flex-col h-full bg-rose-50/20">
      <div className="p-6 pb-4 flex justify-between items-center bg-white/50 backdrop-blur-sm">
        <div className="flex flex-col">
          ...
          {isSaving && (
            <span className="text-[11px] text-rose-400 font-bold uppercase mt-1 animate-pulse flex items-center">
      ...
      <div className="flex-1 overflow-y-auto p-4 space-y-4 pb-32">
        ...
        <div className="bg-white rounded-3xl border border-rose-100 shadow-sm overflow-hidden">
          <table className="w-full table-fixed">
            <thead className="bg-rose-50/30 text-rose-400 text-[10px] font-bold uppercase tracking-widest">
              <tr>
                ...
                return (
                  <tr key={p.id} className="transition-all active:bg-rose-50/40">
                    ...
                    <td className="px-1 py-5 text-center">
                       <span className={`text-[9px] px-1 py-0.5 rounded-md border font-bold tracking-tighter block truncate ${statusStyles}`}>
                         {p.dueDate.slice(5)}
                       </span>
                    </td>
